...
| additional_dependencies | :x: | - | Install additional dependencies (such as Prettier plugins), i.e. `"@prettier/plugin-php" "@prettier/plugin-other"`. Must be wrapped in quotes since @ is a reserved character in YAML. |
